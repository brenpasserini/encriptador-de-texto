const textoArea1 = document.querySelector(".container__textarea--primary");
const textoArea2 = document.querySelector(".container__textarea--secondary");
...
function btnencriptar(){
    ...
    document.querySelector(".container__textarea--secondary").style.display= "block";
...
function btnCopyText(){
    const textoCopiado = document.querySelector(".container__textarea--secondary");
    textoCopiado.select();
